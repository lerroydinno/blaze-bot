...
(function() {
  ...
  function crossValidate(){
    ...
    const sha = predictSHA(latestHash); if(sha!==null) votes[sha]=(votes[sha]||0)+1;
    let best=[null,0];
  ...
  BlazeInterface.prototype.updateResults = function(d){
    ...
    // registra SHA (se tiver variável latestHash no seu contexto)
    ...
    // faz votação e exibe confiança no UI
