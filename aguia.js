...
class BlazeInterface {
  constructor() {
    ...
    this.patternHistory = [];
    // Inicializar apenas após o DOM estar carregado
    document.addEventListener('DOMContentLoaded', () => {
      this.initMonitorInterface();
      console.log('[BlazeInterface] DOM carregado, interface inicializada');
    });
  }
  ...
  initMonitorInterface() {
    ...
    console.log('[BlazeInterface] Overlay criado:', this.overlay);
