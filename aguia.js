        ...
        if (pDiv && pred) {
            ...
            pDiv.innerHTML = `
                <div class="prediction-card">
                    <span class="prediction-title">${pred.isWaiting ? 'PREVISÃO PARA PRÓXIMA RODADA' : 'PRÓXIMA COR PREVISTA'}</span>
                    <div class="prediction-value">
                        <span class="color-dot color-dot-${pred.color}"></span>
                        ${pred.colorName}
                    </div>
                    <span class="prediction-accuracy">${acc}% (${this.correctPredictions}/${this.totalPredictions})</span>
                </div>
            `;
